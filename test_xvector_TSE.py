...
from _Lightning_xvector import TSE_Model
from _SuDORMRF_xvector import SuDORMRF_xvector

import torch
import time


# tensorboard --logdir=lightning_logs/ #put in terminal
...
if __name__ == '__main__':
    ...
    model = SuDORMRF_xvector(out_channels=256,
                             in_channels=512,
                             num_blocks=16,
                             upsampling_depth=5,
                             enc_kernel_size=21,
    ...
    model_specs = "train data {}, step size {}, decay {}, additional info: {} \n{}, epochs {}, val_loss {}\n\n" \
        .format(20000, 30, 0.3, "x-vector", version, epoch, val_loss)
